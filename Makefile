...
# Install/Uninstall make script for rust-utilities/cli-rustdoc
...
completion: ## Builds tab completion Bash configuration file for cli-rustdoc
	"help-to-complete" --executable "$(ROOT_DIRECTORY_PATH)/cli-rustdoc" --completion-dir "$(ROOT_DIRECTORY_PATH)/bash-completion" --clobber

link-completion: SHELL := /bin/bash
link-completion: ## Links tab completion  Bash configuration file for cli-rustdoc
